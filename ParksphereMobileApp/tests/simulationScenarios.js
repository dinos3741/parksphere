...
export const SCENARIOS = {
  HAPPY_PATH: {
    ...
    steps: [
      ...
      { label: "Driving (50 km/h)", speed: 50, steps: 0, duration: 40, accel: 1.2, moveDirection: 'AWAY' },
      { label: "Stopping", speed: 5, steps: 0, duration: 10, accel: 1.1, moveDirection: 'AWAY' },
      { label: "Parked (Still)", speed: 0, steps: 0, duration: 10, accel: 1.0 },
      { label: "Walking Away", speed: 5, steps: 1.8, duration: 30, accel: 1.2, moveDirection: 'AWAY' }
    ]
  },
  BUS_TRIP: {
    ...
    steps: [
      ...
      { label: "Bus Driving", speed: 35, steps: 0, duration: 40, accel: 1.3, moveDirection: 'AWAY' },
  ...
  RETURN_TO_CAR: {
    ...
    steps: [
      { label: "Walking to Car", speed: 4.5, steps: 1.7, duration: 60, accel: 1.2, startDistance: 80, moveDirection: 'TOWARD' },
      { label: "Standing at Door", speed: 0.5, steps: 0.2, duration: 10, accel: 1.0, startDistance: 1.5, moveDirection: 'TOWARD' },
      { label: "Inside Car (Still)", speed: 0, steps: 0, duration: 10, accel: 1.0, startDistance: 0.5 },
      { label: "Driving Away", speed: 30, steps: 0, duration: 60, accel: 1.4, moveDirection: 'AWAY', bluetoothConnected: true }
    ]
  },
  INDOOR_JITTER: {
  ...
  REAL_LIFE_ODYSSEY: {
    ...
    description: "Walk to car, drive in a loop, park at home, walk away, and return.",
    steps: [
      ...
      { label: "Drive Out", speed: 40, steps: 0, duration: 40, moveDirection: 'AWAY', accel: 1.3 },
      { label: "Traffic Light", speed: 0, steps: 0, duration: 20, accel: 1.0 },
      { label: "Drive Home", speed: 65, steps: 0, duration: 50, moveDirection: 'TOWARD', accel: 1.4 },
      { label: "Park at Home", speed: 0, steps: 0, duration: 60, accel: 1.0, startDistance: 0.5 }, 
      { label: "Walk Away", speed: 4.5, steps: 1.8, duration: 40, moveDirection: 'AWAY', accel: 1.2 }, 
      { label: "Long Wait", speed: 0, steps: 0, duration: 60, startDistance: 150, accel: 1.0 }, 
      { label: "Start Return", speed: 4, steps: 1.5, duration: 30, startDistance: 150, moveDirection: 'TOWARD', accel: 1.2 }, // 150 - 120 = 30m
      { label: "Final Approach", speed: 1.5, steps: 0.8, duration: 20, moveDirection: 'TOWARD', accel: 1.0 }, // 30 - 30 = 0m
  ...
  EXTREME_ODYSSEY: {
    ...
    steps: [
      ...
      { label: "Drive AWAY", speed: 45, steps: 0, duration: 40, moveDirection: 'AWAY', accel: 1.3 },
      { label: "Drive TOWARD", speed: 50, steps: 0, duration: 40, moveDirection: 'TOWARD', accel: 1.3 },
      { label: "Park", speed: 0, steps: 0, duration: 30, startDistance: 0.5, accel: 1.0 },
      { label: "Walk Away", speed: 5, steps: 1.7, duration: 40, moveDirection: 'AWAY', accel: 1.2 },
      { label: "Intermission (Far)", speed: 0, steps: 0, duration: 60, startDistance: 200, accel: 1.0 }, 
      { label: "Return Journey", speed: 4.5, steps: 1.8, duration: 40, moveDirection: 'TOWARD', startDistance: 200, accel: 1.4 }, // 200 - 180 = 20m
      { label: "Final Sprint Back", speed: 2, steps: 1.5, duration: 10, moveDirection: 'TOWARD', accel: 1.3 }, // 20 - 20 = 0m
      { label: "Back in Car", speed: 0, steps: 0, duration: 10, startDistance: 0.5, accel: 1.0, bluetoothConnected: true },
      { label: "Drive Away", speed: 40, steps: 0, duration: 60, moveDirection: 'AWAY', accel: 1.4, bluetoothConnected: true }
    ]
  },
  RESIDENTIAL_ARRIVAL: {
  ...
  CITY_TRAFFIC_CLEANUP: {
    ...
    steps: [
      ...
      { label: "Enter Car", speed: 0, steps: 0, duration: 10, startDistance: 0.5, accel: 1.0 },
      { label: "Driving in Traffic", speed: 22, steps: 0, duration: 60, moveDirection: 'AWAY', accel: 1.2, bluetoothConnected: true }
    ]
  },
  GYM_FAILURE_REPRODUCTION: {
    ...
    steps: [
      ...
      { label: "Drive Away", speed: 25, steps: 0, duration: 40, moveDirection: 'AWAY', accel: 1.3 },
      { label: "Stop: Red Light", speed: 0, steps: 0, duration: 15, accel: 1.0 },
      { label: "Drive Return", speed: 45, steps: 0, duration: 40, moveDirection: 'TOWARD', accel: 1.4 },
      { label: "Parked (Gym)", speed: 0, steps: 0, duration: 20, accel: 1.0, startDistance: 0.5 },
      ...
      { label: "Drive Away Fast", speed: 35, steps: 0, duration: 60, moveDirection: 'AWAY', accel: 1.5, bluetoothConnected: true }
    ]
  },
  CLOSE_PROXIMITY_PARKING: {
    ...
    steps: [
      ...
      { label: "Return to Park", speed: 45, steps: 0, duration: 40, moveDirection: 'TOWARD', accel: 1.4 },
      { label: "Park & Exit", speed: 0, steps: 0, duration: 15, accel: 1.0, startDistance: 0.5 },
      { label: "Walk to Bench", speed: 2, steps: 0.8, duration: 15, moveDirection: 'AWAY', startDistance: 0.5, accel: 1.1 },
      { label: "Sitting (10m away)", speed: 0.2, steps: 0, duration: 60, startDistance: 10, accel: 1.0 }, 
      { label: "Walk back to Car", speed: 2, steps: 0.8, duration: 10, moveDirection: 'TOWARD', startDistance: 10, accel: 1.1 },
      { label: "Enter & Drive", speed: 30, steps: 0, duration: 60, moveDirection: 'AWAY', accel: 1.3, bluetoothConnected: true }
    ]
  },
  BUS_COMMUTE_STRESS: {
    ...
    steps: [
      ...
      { label: "Drive to Spot", speed: 40, steps: 0, duration: 60, moveDirection: 'AWAY', accel: 1.3 },
      { label: "Park & Exit", speed: 0, steps: 0, duration: 15, accel: 1.0, startDistance: 0.5 },
      { label: "Walk to Bus Stop", speed: 4.5, steps: 1.8, duration: 40, moveDirection: 'AWAY', accel: 1.2 },
      ...
      { label: "Walk back to Car", speed: 4, steps: 1.5, duration: 35, moveDirection: 'TOWARD', startDistance: 120, accel: 1.2 },
      { label: "Getting In (Final)", speed: 0.5, steps: 0.2, duration: 10, startDistance: 1.5, accel: 1.0, bluetoothConnected: true },
      { label: "Drive Home", speed: 40, steps: 0, duration: 60, moveDirection: 'AWAY', accel: 1.4, bluetoothConnected: true }
    ]
  },
  OFFSET_SPOT_DEPARTURE: {
    ...
    steps: [
      { label: "Initial Drive", speed: 40, steps: 0, duration: 40, moveDirection: 'AWAY', accel: 1.3 },
      { label: "Park & Exit", speed: 0, steps: 0, duration: 10, accel: 1.0, startDistance: 18 },
      { label: "Walk Away", speed: 4, steps: 1.5, duration: 40, moveDirection: 'AWAY', startDistance: 18, accel: 1.2 }, 
      { label: "Wait (Away)", speed: 0, steps: 0, duration: 30, startDistance: 150, accel: 1.0 },
      { label: "Return to Car", speed: 4, steps: 1.5, duration: 35, moveDirection: 'TOWARD', startDistance: 18, accel: 1.2 },
      { label: "Getting In", speed: 0.5, steps: 0.2, duration: 10, startDistance: 18, accel: 1.0, bluetoothConnected: true }, 
      { label: "Drive Away", speed: 35, steps: 0, duration: 60, moveDirection: 'AWAY', startDistance: 18, accel: 1.4, bluetoothConnected: true }
    ]
  },
  CLOSE_WALK_PASS_BY: {
    ...
    steps: [
      ...
      { label: "Walk to Sidewalk", speed: 3, steps: 1.2, duration: 15, moveDirection: 'AWAY', startDistance: 2, accel: 1.1 },
      ...
      { label: "Loop Around (15m)", speed: 4, steps: 1.5, duration: 25, startDistance: 15, moveDirection: 'AWAY', accel: 1.1 },
      { label: "Walk Past Again (8m)", speed: 3.5, steps: 1.4, duration: 20, startDistance: 8, moveDirection: 'TOWARD', accel: 1.1 },
      { label: "Finally Leave", speed: 5, steps: 1.8, duration: 35, startDistance: 15, moveDirection: 'AWAY', accel: 1.2 }
    ]
  },
  FIELD_TEST_REPLICA: {
    ...
    steps: [
      { label: "Initial Drive", speed: 45, steps: 0, duration: 40, moveDirection: 'AWAY', accel: 1.4 },
      { label: "Park at Work", speed: 0, steps: 0, duration: 15, accel: 1.0, startDistance: 0.5 },
      { label: "Walk Away", speed: 4.5, steps: 1.8, duration: 30, moveDirection: 'AWAY', accel: 1.2 },
      { label: "Coffee Break (Far)", speed: 0, steps: 0, duration: 60, startDistance: 150, accel: 1.0 },
      { label: "Start Return", speed: 4, steps: 1.5, duration: 40, moveDirection: 'TOWARD', accel: 1.2 },
      { label: "Close Approach (7m)", speed: 1.2, steps: 0.5, duration: 15, startDistance: 7, moveDirection: 'TOWARD', accel: 1.0 },
      { label: "Get In & Leave", speed: 35, steps: 0, duration: 60, moveDirection: 'AWAY', accel: 1.5, bluetoothConnected: true },
      { label: "Drive Home", speed: 50, steps: 0, duration: 60, moveDirection: 'TOWARD', accel: 1.4 }, 
      { label: "Park at Home", speed: 0, steps: 0, duration: 20, accel: 1.0, startDistance: 0.5 }, 
  ...
  TRAFFIC_STRESS: {
    ...
    steps: [
      { label: "Start Driving", speed: 30, steps: 0, duration: 40, moveDirection: 'AWAY', accel: 1.3 },
      ...
      { label: "Medium Block", speed: 45, steps: 0, duration: 40, moveDirection: 'AWAY', accel: 1.3 },
      { label: "Red Light 3", speed: 0, steps: 0, duration: 20, accel: 1.0 },
      { label: "Final Park", speed: 5, steps: 0, duration: 10, accel: 1.1 },
