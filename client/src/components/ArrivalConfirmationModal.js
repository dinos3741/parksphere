...
const ArrivalConfirmationModal = ({ isOpen, onClose, onConfirm, onNotIdentified, isOwner, requesterUsername, spotId }) => {
    ...
    <div className="arrival-modal-overlay">
      <div className="arrival-modal-content">
        <div className="arrival-modal-header">
          ...
          {!isOwner && <button className="arrival-modal-close-button" onClick={onClose}>&times;</button>}
        </div>
        ...
        <div className="arrival-modal-footer">
          {isOwner ? (
            <>
              ...
              <button className="arrival-cancel-button" onClick={onNotIdentified}>Not Identified</button>
            </>
          ) : (
            <>
              <button className="arrival-confirm-button" onClick={onConfirm}>Confirm</button>
